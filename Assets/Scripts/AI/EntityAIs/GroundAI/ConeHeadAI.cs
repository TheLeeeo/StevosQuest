...
public class ConeHeadAI : AIBase
{
    private State_JumpToPlayer _JumpToPLayerAndAttackState;
    private State_RandomJumpStrolling _JumpStrollState;
    ...
    private void Start()
    {
        _JumpStrollState = new State_RandomJumpStrolling(this, entityController) { MinMoveDist = this.MinMoveDist, MaxMoveDist = this.MaxMoveDist, MinWaitTime = this.MinWaitTime, MaxWaitTime = this.MaxWaitTime, JumpDistance = this.JumpDistance, JumpHeight = this.JumpHeight};
