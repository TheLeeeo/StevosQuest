...
public class BleedingEffectBehaviour : EffectBase
{
    [SerializeField]
    ...
    public void Update()
    {
        ...
        if (timer <= 0)
        {
            ...
            entityController.health.Damage(Mathf.CeilToInt(entityController.health.MaxHealth * (0.1f * Item.RarityPowerMultipliers[effectLevel])));
        }
        if (timeLeft <= 0)
        {
